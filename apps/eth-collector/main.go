...
var (
	...
	httpRequestsTotal = prometheus.NewCounterVec(
		prometheus.CounterOpts{
			Name: "eth-collector_http_requests_total",
	...
	httpRequestDuration = prometheus.NewHistogramVec(
		prometheus.HistogramOpts{
			Name:    "eth-collector_http_request_duration_seconds",
	...
	dataCollectionTotal = prometheus.NewCounter(
		prometheus.CounterOpts{
			Name: "eth-collector_data_collection_total",
	...
	dataCollectionErrors = prometheus.NewCounter(
		prometheus.CounterOpts{
			Name: "eth-collector_data_collection_errors_total",
	...
	apiCallsTotal = prometheus.NewCounterVec(
		prometheus.CounterOpts{
			Name: "eth-collector_api_calls_total",
